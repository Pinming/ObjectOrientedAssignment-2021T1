...
public class FushiSystem {
	 ...
	 */
	public static StudentCatalog loadStudent() {
	 ...
	 */
	private void lookupTestScore() throws IOException { // Function 7
		Student student = readStudent();
		if (student == null){
			stdErr.print("Wrong ID! Please re-enter student ID.");
		} else if (student.getExamPaper() == null){
			stdErr.print("No test paper have been generated for this student.");
		} else if (student.getExamPaper().getTotalScore() == 0){
			...
			for (TestItem testItem : student.getExamPaper().testItems){
				cnt++;
				stdOut.println("The score of item " + cnt + " is: " + testItem.getScore());
			}
		}
		// hand written code goes here... Function 7
	}

	/**
	 * Look up the total score of the student.
	 */
	private void lookupTotalScore() throws IOException { // Function 6
		Student student = readStudent();
		if (student == null){
			stdErr.print("Wrong ID! Please re-enter student ID.");
		} else if (student.getExamPaper() == null){
			...
			stdOut.println("The total score of the student is: " +
					student.getExamPaper().getTotalScore());
		}
	 ...
	 */
	private void entryScore() throws IOException { // Function 5
	 ...
	 */
	private void generateExamPaper() throws IOException { // Function 4
	 ...
	 */
	private void displayExamPaper() throws IOException { // Function 3
	...
	private Student addStudent() throws IOException {
		stdErr.println("Student ID > ");
		stdErr.flush();
		String id = String.valueOf(stdIn.readLine());
		stdErr.println("Student Name > ");
		stdErr.flush();
		String name = String.valueOf(stdIn.readLine());
