...
public class FushiSystem {
    ...
    /**
     * Write students and theirs exam papers to a file.
     * The output file will be saved at the folder of the project.
     * @param fileName The file name of output file.
     * @param content The formatter.
     * @throws IOException
     */
